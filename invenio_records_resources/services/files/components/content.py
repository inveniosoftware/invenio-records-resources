...
class FileContentComponent(FileServiceComponent):
    ...
    def set_file_content(
        self, identity, id, file_key, stream, content_length, record, record_files
    ):
        ...
        file_record = record_files.get(file_key)
        ...
        transfer.set_file_content(
            ...
            content_length,
            record_files,
            bucket=self.service.get_bucket(record),
        )

    def get_file_content(self, identity, id, file_key, record, record_files):
