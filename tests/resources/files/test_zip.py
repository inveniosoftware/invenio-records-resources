...
def record_with_zip_before_commit(
        file_service, location, record_before_file_init, identity_simple, zip_fp, monkeypatch
):
    """Image metadata extraction."""
...
@pytest.fixture()
def record_with_zip(
        file_service, location, record_with_zip_before_commit, identity_simple, zip_fp, monkeypatch
):
    """Image metadata extraction."""
    # Patch celery task
    task = MagicMock()
